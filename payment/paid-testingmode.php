    ...
    "paymentInfo" => array(
        ...
        "transactions" => array(
            array(
                ...
                "beneficiaries" => array(
                    array(
                        "beneficiaryAcctNumber" => "9910299100501",
...
$url = "https://api-dev02.noqodi.com/v2/payments/capture";
        // Initialize cURL
        $ch = curl_init();
...
// var_dump($data);
		...
		if($status != 'SUCCESS'){
			...
			$json_data = json_encode($data);
			$url = "https://api-dev02.noqodi.com/v2/payments/voidAuth";
					// Initialize cURL
					$ch = curl_init();
	...
	$json_data = json_encode($data);
	$url = "https://api-dev02.noqodi.com/v2/transactions/completePay";
			// Initialize cURL
			$ch = curl_init();
...
Date: <span class="invoice"><?php echo date('d F Y'); ?></span> 
